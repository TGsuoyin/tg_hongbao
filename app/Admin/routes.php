...
Route::group([
    ...
    $router->get('user-statics', 'UserStaticsController@index');
    $router->get('jackpotrecord', 'JackpotRecordController@index');
    $router->get('jackpotreward', 'JackpotRewardController@index');
